...
class GameSettingsView: NavigationView {
	...
	private var isNew: Bool = false {
		didSet {
			self.bar.title = isNew ? "new game" : "setting"
		}
	}
	...
	private func initDataSource() {
		self.dataSource.append(("帥", "RED", UserPreference.shared.game.red))
		self.dataSource.append(("將", "BLACK", UserPreference.shared.game.black))
		self.dataSource.append(("AI", "LEVEL", UserPreference.shared.game.prompt))
	}
